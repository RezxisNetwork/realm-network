...
public class HostAnniServerStatusSigns extends Packet {
	...
	public HostAnniServerStatusSigns(String serverName, boolean joinable, int maxPlayers, int onlinePlayers,
